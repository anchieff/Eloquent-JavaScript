...
// Фильтрация массивов ======================================================================================================
/* function filter(array, test) { //не преобразует массив, а создает новый. Эта функция чистая
  let passed = [];
...
// Ищем систему письма с наибольшим количеством символов
// function characterCount(script) {
//   return script.ranges.reduce((count, [from, to]) => { //деструктуризация
...
// some - принимает тестовую функцию и сообщает, возвращает ли она true для любого элемента массива
...
console.log(textScripts('"woof", "колобок", ""chicken'));